...
const HISTORY_DATA = [
  { year: 2026, items: [
    { date: "2026. 03", text: "중기부, 모두의 창업 주관기관 선정" },
    { date: "2026. 03", text: "중기부, '2026 특화 역량 BI 육성지원사업' 주관기관 선정" },
  ]},
  { year: 2025, items: [
    { date: "2025. 12", text: "한동대학교 산학협력단 RISE사업단 기업밀착 보육 및 사업화지원 프로그램 운영 용역기관 선정" },
    { date: "2025. 11", text: "한동대학교 산학협력단 RISE사업단 경북지역 ESG 역량 강화 프로그램 운영 용역기관 선정" },
    { date: "2025. 07", text: "경북문화재단 '경북 북부 청년크리에이터 성장지원사업' 용역기관 선정" },
