...
export const FALLBACK_PORTFOLIO = [
  { 
    ...
    name_en: "IRONBOX", 
    category: "AI/로봇", 
    description: "지능형 산업 로봇 및 감시 솔루션", 
    investment_year: 2019, 
    sort_order: 1, 
    status: "active",
    ceo: "오상택",
    founded: "2019.01.10",
    achievements: "벤처기업인증, 한국기업데이터 기술평가 우수기업 인증(T4)",
    website: null,
    exited: false,
    slug: "ironbox"
  },
  ...
  { 
    ...
    category: "AI/로봇", 
    description: "AI 기반 화재 감시 솔루션", 
    investment_year: 2020, 
    sort_order: 3, 
    status: "active",
    ceo: "이성진",
    founded: "2020.12.24",
    achievements: "벤처기업인증, 서울혁신챌린지 선정 등",
  ...
  { 
    ...
    name_en: "OpenIn", 
    category: "AI/로봇", 
    description: "ML 기반 지능형 CCTV 솔루션", 
    investment_year: 2020, 
    sort_order: 4, 
    status: "active",
    ceo: "박정호",
    founded: "2020.11.28",
    achievements: "포스코 협동 로봇 솔루션 공동 R&D 협약 체결 등",
  ...
  { 
    ...
    category: "에너지/환경", 
    description: "열회수 환기 장치", 
    investment_year: 2020, 
    sort_order: 5, 
    status: "active",
    ceo: "고대권",
    founded: "2020.11.27",
    achievements: "벤처기업인증, 혁신기업인증 등",
    website: null,
    exited: false,
    slug: "ecom"
  },
  { 
    ...
    name_en: "Dasom X", 
    category: "AI/IT", 
    description: "AI Agentic workflow 기반 플랫폼 개발", 
    investment_year: 2025, 
    sort_order: 6, 
    status: "active",
    ceo: "최명진",
    founded: "2024.09.02",
    achievements: "기업부설연구소설립, 포항시 외국인 정착 지원 에이전트 '팡이' 개발",
    website: null,
    exited: false,
    slug: "dasom-x"
  },
